			...
			<div class="page-content-wrapper">
				<div class="page-content">
                    ...
                    <?php
                        ...
                        {
                                $result=mysqli_query($conn,"update tbl_user set user_time='".$_REQUEST["txtdel"]."' where user_id='".$_REQUEST["user"]."'") or die(mysqli_error($conn));
                                if($result=true)
                                {   
