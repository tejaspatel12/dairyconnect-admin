								...
								<div class="tab-content mt-3">
									<div class="tab-pane fade show active" id="Experience">
										<div class="card shadow-none border mb-0 radius-15">
											...
											<form method="post" action="invoice/index.php">
                                                <div class="row">
                                                        ...
                                                        <div class="d-md-flex align-items-center">
                                                            <div class="ml-md-4 flex-grow-1" style="margin-top: 1rem;" >
																...
																<div class="col-md-12 mb-3">
																	...
																	<input type="hidden" name="txtuser" value="<?php echo $_REQUEST["user"];?>" class="form-control" required>
																</div>
																...
																<button type="submit" name="BtnAdminInvoice" class="btn btn-primary m-1 px-5 radius-30">Continue</button>
