				...
				<div class="page-content">
	                ...
	                <?php
                        if(isset($_REQUEST["BtnSave$title"]))
                        {
                                ...
                                $result=mysqli_query($conn,"insert into tbl_recharge_offer (ro_title,ro_des,ro_amt,ro_get_amt) 
                                values ('".$_REQUEST['txttitle']."','".$_REQUEST['txtdes']."','".$_REQUEST['txtramt']."','".$_REQUEST['txtoamt']."')") or die(mysqli_error($conn));
                                if($result=true)
                                {   
                            ...
                            <form method="post" enctype="multipart/form-data">
								<div class="form-row">
									...
									<div class="col-md-12 mb-3">
                                        ...
                                        <textarea rows="5" class="form-control" name="txtdes"></textarea>
										<!-- <div class="valid-feedback">Looks good!</div> -->
									</div>

									<div class="col-md-12 mb-3">
										<label for="validationCustom01">Recharge Amount</label>
										<input type="number" name="txtramt" class="form-control" required>
										<!-- <div class="valid-feedback">Looks good!</div> -->
									</div>

									<div class="col-md-12 mb-3">
										<label for="validationCustom01">Offer Amount</label>
										<input type="number" name="txtoamt" class="form-control" required>
										<!-- <div class="valid-feedback">Looks good!</div> -->
									</div>
