				...
				<div class="page-content">
                    ...
                    <?php
                        if(isset($_REQUEST["BtnSave$title"]))
                        {
                                ...
                                $result=mysqli_query($conn,"insert into tbl_category (category_name,category_img,category_status) 
                                values ('".$_REQUEST['txtname']."','".$newname."','1')") or die(mysqli_error($conn));
                                if($result=true)
                                {   
                            ...
                            <form method="post" enctype="multipart/form-data">
								<div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
										<label for="validationCustom01"><?php echo $title; ?> Image</label>
