			...
			<div class="page-content-wrapper">
				<div class="page-content">
                    ...
                    if(isset($_REQUEST["BtnSave$title"]))
                    {
                            ...
                            $result=mysqli_query($conn,"insert into tbl_area (city_id,area_name,area_status) 
                            values ('".$_REQUEST['txtcity']."','".$_REQUEST['txtname']."','1')") or die(mysqli_error($conn));
                            if($result=true)
                            {   
								    ...
								    <div class="col-md-12 mb-3">
										...
										<select class="form-control" name="txtcity">
											<option>Select Dealer</option>
											   <?php
                                                $result=mysqli_query($conn,"select * from tbl_city where city_status='1' and state_id='5'");
