				...
				<div class="page-content">
	                ...
	                <?php
                        if(isset($_REQUEST["BtnSave$title"]))
                        {
                                ...
                                $result=mysqli_query($conn,"insert into tbl_faq (faq_question,faq_answer) 
                                values ('".$_REQUEST['txtque']."','".$_REQUEST['txtans']."')") or die(mysqli_error($conn));
                                if($result=true)
                                {   
                            ...
                            <form method="post" enctype="multipart/form-data">
								<div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
										<label for="validationCustom01"><?php echo $title; ?> Question</label>
										<input type="text" name="txtque" class="form-control" required>
										<!-- <div class="valid-feedback">Looks good!</div> -->
									</div>
									
									<div class="col-md-12 mb-3">
										<label for="validationCustom01"><?php echo $title; ?> Answer</label>
										
                                        <textarea rows="5" class="form-control" name="txtans"></textarea>
										<!-- <div class="valid-feedback">Looks good!</div> -->
									</div>
